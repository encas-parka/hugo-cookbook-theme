/**
 * Vuejs App Ingredients List for single.ingredients.html
 * Load by ./boostrap.js
 * Data from json Hugo generated by single.ingredientsjson.json
 * Use ./ingredientCalculator.js functions
 */
  ...
  return Vue.createApp({
    ...
    methods: {
      ...
      async checkAuthenticationStatus() {
        try {
          this.isAuthenticated = await window.AppwriteClient.isAuthenticatedCms();
          console.log(`[Vue App] Statut d'authentification: ${this.isAuthenticated}`);
        } catch (error) {
      ...
      redirectToCollaborativeList(listId) {
        // Construire l'URL vers l'application collaborative avec un query parameter
