...
require (
	github.com/encas-parka/hugo-cookbook-theme v0.0.0-20240124235845-c082f4233465 // indirect
	...
	github.com/thkukuk/hugo-photoswipe5-gallery v0.0.0-20240118103044-67b4c9e245ae // indirect
