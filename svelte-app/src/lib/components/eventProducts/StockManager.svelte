      ...
      <div class="card-body">
        ...
        <div class="mb-4">
          ...
          >
            ...
            <strong>ultérieurement</strong>
            seront pris en compte dans le calcul des quantités manquantes à se fournir.
          </InfoCollapse>
        </div>
    ...
    <div class="card-body">
      ...
      <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
        ...
        <div>
          ...
          <span class="ml-2">{formatDate(modalState.stockParsed.dateTime)}</span
          >
        </div>
